				...
				<div class="midiaq">
					...
					<div class="search_block flfull">
						<div class="fl">
							...
							<div>
								<span class="search_th">내용 검색</span> <input type="text" class=""
									placeholder="내용 검색">
							</div>
							<div>
								<span class="search_th">대분류</span> <select class="">
							...
							<div>
								<span class="search_th">소분류</span> <select class="">
									<option value="전체" checked="checked">전체</option>
							...
							<div>
								<span class="search_th">처리자 ID</span> <input type="text"
									class="" placeholder="처리자 ID">
							</div>

							<!-- 2row -->
							<div class="pdt15"></div>
							<div>
								<span class="search_th">접수일</span> <input type="text"
									class="datepicker" readonly placeholder="날짜선택" /> - <input
									type="text" class="datepicker" readonly placeholder="날짜선택" />
							</div>
							<div>
								<span class="search_th">접수시간</span> <select class="" name="">
									<option value="전체" checked="checked">전체</option>
							...
							<div>
								<span class="search_th">처리상태</span> <select class="" name="">
						...
						<div class="fr">
							<div class="search_btn_area">
								<a href="#" class="normal_btn purplebtn">검색</a> <a
									href="minwon_reg.html" class="normal_btn purplebtn02">등록</a>
							</div>
						</div>
					</div>
					...
					<div class="full_collum collum">
						<ul>
							<li class="collum_tit">
								...
								<ul>
									<li>
										<table cellpadding="0" cellspacing="0" class="col_8"
											width="100%;">
											<tr>
												<th>표시</th>
												<th>번호</th>
											...
											<tr>
												...
												<td>무선</td>
												<td>.....</td>
												<td><a title="상세보기(클릭)" href="minwon_regView.html">
														제목 </a></td>
												<td>2017-03-01</td>
												<td>01시 20분</td>
												<td>처리완료</td>
										...
										<div class="page">
											<ul>
												...
												<li><a href="#">4</a></li>
												<li><a href="#">5</a></li>
												<li style="margin-left: 5px;"><a href="#"><i
